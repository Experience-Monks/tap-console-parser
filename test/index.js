...
function ready () {
  test('should have some asserts', function (t) {
    ...
    t.deepEqual(asserts[1], { error: { actual: '51', at: { character: '5', file: 'basic.js', line: '5' }, expected: 'true', operator: 'equal', raw: { actual: '   51', at: ' Test.<anonymous> (basic.js:5:5)', expected: ' true', operator: ' equal' } }, name: 'something wrong', number: 2, ok: false, raw: 'not ok 2 something wrong', test: 1, type: 'assert' })
